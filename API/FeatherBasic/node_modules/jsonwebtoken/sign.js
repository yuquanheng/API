...
module.exports = function (payload, secretOrPrivateKey, options, callback) {
  ...
  if (typeof options.expiresIn !== 'undefined' && typeof payload === 'object') {
	//options.expiresIn = options.expireIn;
	console.log("111111111111111:"+options.expiresIn);
  ...
  console.log("ParaS:"+JSON.stringify(payload));
  //yuquanheng add
  if(payload.expireTime){
	  
	payload.exp = timespan(payload.expireTime,timestamp);  
	
	delete payload.expireTime;
  }
  console.log("ParaS111:"+JSON.stringify(payload));
