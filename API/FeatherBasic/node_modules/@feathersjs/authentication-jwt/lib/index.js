...
function init (options = {}) {
  return function jwtAuth () {
    ...
    //console.log("232::"+JSON.stringify(jwtSettings.jwt)); 
	jwtSettings.jwt.expiresIn="2d"
    ...
    app.setup = function () {
	  ...
	  strategyOptions.expiresIn="3d"
	  //console.log('Registering jwt authentication strategy with options:', strategyOptions);
