...
class JWTVerifier {
  constructor (app, options = {}) {
	...
	//console.log('Received JWT payload:'+JSON.stringify(options));  
    this.app = app;
  ...
  verify (req, payload, done) {
    ...
    if (id === undefined) {
		console.log(`JWT payload does not contain ${this.options.entity}Id`);
      debug(`JWT payload does not contain ${this.options.entity}Id`);
      return done(null, {}, payload);
    }

    debug(`Looking up ${this.options.entity} by id`, id);
    console.log(`Looking up ${this.options.entity} by id`, id);
